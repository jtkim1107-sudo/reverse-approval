...
// 2026-09-13 대시보드 정리: 고객문의 건수는 '오늘 해야 할 일'(CsInquiries.summary), 브리핑 상세 바로 아래 고객문의 줄은 그대로
check(appSrc.includes("CsInquiries.summary(cs.v.rows)") && /rg-sales-statistics-mount">\$\{briefingHtml\}<\/div>[\s\S]{0,200}오전 브리핑 · 고객문의<\/b>\$\{CsInquiries\.briefingLineHtml\(csData\)\}/.test(appSrc),
  "대시보드 할 일(고객문의 건수) + 브리핑 영역 바로 아래 고객문의 줄(판매통계 패널이 브리핑 영역을 다시 그려도 남음)");
